...
import com.coocaa.coocaatvmanager.bean.TaskInfo;
import com.coocaa.coocaatvmanager.dataSource.TaskInfoProvider;
import com.coocaa.coocaatvmanager.utils.SystemInfoUtils;

import java.util.ArrayList;
import java.util.List;


public class CoocaaTaskManagerActivity extends Activity {
	...
	public void killAll(View view) {
		...
		adapter.notifyDataSetChanged();
		Toast.makeText(getApplicationContext(), "消除"+ count + "个进程，释放" + Formatter.formatFileSize(this, savedMen) + "M内存", Toast.LENGTH_SHORT).show();
