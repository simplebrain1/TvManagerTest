/*
package com.coocaa.coocaatvmanager.utils.aop;
...
public class TraceActivity {
    private static String TAG = TraceActivity.class.getSimpleName();
    ...
    public Object activityOnXXXAdvice(ProceedingJoinPoint proceedingJoinPoint) {
        ...
        try {
            ...
            Log.i(TAG,  " signature" +   sign+" ,methodName:"+methodName+",activityName:"+activityName);
