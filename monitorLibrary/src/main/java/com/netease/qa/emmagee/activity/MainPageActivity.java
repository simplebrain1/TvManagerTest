...
//				}
		...
		lstViProgramme.setDescendantFocusability(ViewGroup.FOCUS_AFTER_DESCENDANTS);
		...
		lstViProgramme.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
			@Override
		...
		lstViProgramme.setOnFocusChangeListener(new View.OnFocusChangeListener() {
			@Override
